...
public class PropSegment : MonoBehaviour {
    ...
    public void Update() {
        if (VoxelTerrain.Instance.VoxelProps.renderInstancedMeshes && instancedIndirectProps != null) {
        ...
        if (VoxelTerrain.Instance.VoxelProps.renderBillboards && billboardProps != null) {
